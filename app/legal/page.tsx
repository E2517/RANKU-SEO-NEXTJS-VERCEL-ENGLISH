    ...
    return (
        <div className={styles.container}>
            <div className={styles.card}>
                <h1 className={styles.mainTitle}>Legal Information</h1>

                <section id="aviso-legal" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Legal Notice</h2>
                    <h3 className={styles.subTitle}>1. Identification Details</h3>
                    <p className={styles.text}>
                        In compliance with Europe Data Proteccion
                    </p>
                    ...
                    <p className={styles.text}>
                        Use of the website implies full and unconditional acceptance of all the provisions included in this Legal Notice.
                    </p>
                </section>

                <section id="condiciones-contratacion" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Terms of Service</h2>
                    <h3 className={styles.subTitle}>Service Subscription</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Subscription Process</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Service Cancellation</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Platform Access</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Modification of Terms</h3>
                    <p className={styles.text}>
                    ...
                    <h3 className={styles.subTitle}>Service Availability</h3>
                    <p className={styles.text}>
                ...
                <section id="resolucion-litigios" className={styles.section}>
                    ...
                    <p className={styles.text}>
                        In the event of a dispute, an amicable resolution will be attempted. For consumer users, the European Commission provides an online dispute resolution platform: <a href="https://consumer-redress.ec.europa.eu/dispute-resolution-bodies" target="_blank" rel="noopener noreferrer" className={styles.link}>https://consumer-redress.ec.europa.eu/dispute-resolution-bodies</a>
                    </p>
                </section>
                ...
                <section id="cuenta-usuario" className={styles.section}>
                    <h2 className={styles.sectionTitle}>User Account and Error Correction</h2>
                    <p className={styles.text}>
                ...
                <section id="precios" className={styles.section}>
                    <h2 className={styles.sectionTitle}>Prices, Taxes, Fees, and Duties</h2>
                    <p className={styles.text}>
